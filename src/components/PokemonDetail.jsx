...
const AppPokemonDetails = () => {
  ...
  return (
    <div className="app__details py-6">
      <div className=" w-11/12 sm:w-2/3 md:w-1/2 lg:w-1/3 m-auto my-10 py-8 bg-white border border-gray-300 shadow-xl rounded-xl text-center text-xl">
        ...
        <div className="flex flex-col justify-center gap-4 mb-6 items-center">
          <img
            ...
            src={
              isHovered ? pokemonInfo?.sprites?.back_default || image : image
            }
            alt={pokemon?.name}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 items-start  px-4">
          <Link
            ...
            to="/"
          >
            Torna alla Lista <i className="ml-3 pi pi-database"></i>
          </Link>
          <Link
